...
/**
 * SP-API execution class for the Sellers API v1. See official documentation:
 * https://developer-docs.amazon.com/sp-api/docs/sellers-api-v1-reference
 */
class SellersV1ApiExecution extends SpApiExecution
{
    public function getOperationToClientDictionary()
    {
        return [
            'getMarketplaceParticipations' => SellersApi::class,
        ];
    }
}
