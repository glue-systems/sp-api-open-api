...
namespace Glue\SPAPI\OpenAPI\Clients\SupplySourcesV20200701;

use Glue\SPAPI\OpenAPI\Clients\SupplySourcesV20200701\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Glue\SPAPI\OpenAPI\Clients\SupplySourcesV20200701\Model\\' . $data->{$discriminator};
