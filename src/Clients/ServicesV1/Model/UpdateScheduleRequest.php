...
class UpdateScheduleRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'schedules' => '\Glue\SpApi\OpenAPI\Clients\ServicesV1\Model\AvailabilityRecord[]'
    ];
     ...
     * Sets schedules
     *
     * @param \Glue\SpApi\OpenAPI\Clients\ServicesV1\Model\AvailabilityRecord[] $schedules List of `AvailabilityRecord`s to represent the capacity of a resource over a time range.
     *
     * @return $this
     */
