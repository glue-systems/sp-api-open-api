...
class InvoiceData implements ModelInterface, ArrayAccess
{
    ...
    public function setInvoiceNumber($invoiceNumber)
    {
        if ((mb_strlen($invoiceNumber) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoiceNumber when calling InvoiceData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($invoiceNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoiceNumber when calling InvoiceData., must be bigger than or equal to 1.');
        }
