...
class OrderChangeTypeFilter implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'orderChangeTypes' => '\Glue\SpApi\OpenAPI\Clients\NotificationsV1\Model\OrderChangeTypeEnum[]'
    ];
     ...
     *
     * @return \Glue\SpApi\OpenAPI\Clients\NotificationsV1\Model\OrderChangeTypeEnum[]|null
     */
     ...
     *
     * @param \Glue\SpApi\OpenAPI\Clients\NotificationsV1\Model\OrderChangeTypeEnum[]|null $orderChangeTypes A list of order change types to subscribe to (e.g. BuyerRequestedChange). To receive notifications of all change types, do not provide this list.
     *
     * @return $this
     */
