...
namespace Glue\SpApi\OpenAPI\Clients\FbaSmallAndLightV1;

use Glue\SpApi\OpenAPI\Clients\FbaSmallAndLightV1\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Glue\SpApi\OpenAPI\Clients\FbaSmallAndLightV1\Model\\' . $data->{$discriminator};
