...
class VendorDFSandboxtransactionstatusApi
{
    ...
    public function getOrderScenariosWithHttpInfo($transactionId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Glue\SpApi\OpenAPI\Clients\VendorDirectFulfillmentSandboxDataV20211228\Model\TransactionStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Glue\SpApi\OpenAPI\Clients\VendorDirectFulfillmentSandboxDataV20211228\Model\TransactionStatus', []),
            ...
            $returnType = '\Glue\SpApi\OpenAPI\Clients\VendorDirectFulfillmentSandboxDataV20211228\Model\TransactionStatus';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Glue\SpApi\OpenAPI\Clients\VendorDirectFulfillmentSandboxDataV20211228\Model\TransactionStatus',
