...
namespace Glue\SPAPI\OpenAPI\Clients\ReportsV20210630;

use Glue\SPAPI\OpenAPI\Clients\ReportsV20210630\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Glue\SPAPI\OpenAPI\Clients\ReportsV20210630\Model\\' . $data->{$discriminator};
